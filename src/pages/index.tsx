      ...
      <main id="main-content">
          ...
          <div className="max-w-7xl mx-auto px-4 py-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              {allCategories.map((category) => {
                ...
                return (
                  <Link href={isCustom ? "#contact" : `/category/${category.id}`} key={category.id} onClick={() => { if (window.dataLayer) window.dataLayer.push({ event: isCustom ? 'contact_us_card_click' : 'category_card_click', category: category.name }); }}>
        ...
        <section id="suppliers" className="py-20 bg-white">
          <div className="container mx-auto px-4">
            ...
            <div className="flex flex-wrap justify-center items-center gap-12">
              <a href="https://canadasportswear.com" target="_blank" rel="noopener noreferrer" className="transition-transform hover:scale-105 w-40 h-20 flex items-center justify-center" onClick={() => { if (window.dataLayer) window.dataLayer.push({ event: 'supplier_logo_click', supplier: 'Canada Sportswear' }); }}>
                <Image
        ...
        <section id="faq" className="py-20 bg-red-200">
          <div className="container mx-auto px-4 max-w-3xl">
            ...
            <div className="space-y-4">
              {/* FAQ Accordion */}
              <details className="bg-white rounded-xl shadow p-6 group" onClick={() => { if (window.dataLayer) window.dataLayer.push({ event: 'faq_expand', question: 'I don\'t see the type of apparel I want - can you source other items?' }); }}>
        ...
        <section id="contact" className="py-20 bg-gray-50">
          <div className="container mx-auto px-4 max-w-2xl">
            ...
            {!formSubmitted ? (
              <form ref={formRef} className="bg-white rounded-lg shadow-md p-8 space-y-6" onSubmit={e => { handleContactSubmit(e); if (window.dataLayer) window.dataLayer.push({ event: 'contact_form_submit' }); }}>
                {formError && (
